...
def getDayIndex(self):
    ...
    # KOSPI 종목코드 조회
    stock_code = stock.get_market_ohlcv_by_date(fromdate="20210501", todate="20210520", ticker="005930")
    print(stock_code)
    
    kospi = stock.get_market_ohlcv_by_date(today1wago, today, "kospi") # Mirae Asset
    # print(kospi)

    kosdaq = stock.get_market_ohlcv_by_date(today1wago, today, "kosdaq") # Samsung Electronics
    # print(kosdaq)
    kospi200 = stock.get_market_ohlcv_by_date(today1wago, today, 'ks200') # KOSPI 200
...
def getKospiChart(self):
    ...
    stock_month = stock.get_market_ohlcv_by_date(today_1yago, today, 'kospi')
...
def getKosdaqChart(self):
    ...
    stock_month = stock.get_market_ohlcv_by_date(today_1yago, today, 'kosdaq')
